# ------------------------------------------------------------------------------------------------------------#
# Manuscript title: Toward spaceborne mapping of functional variation in diverse tropical forests: a Malaysian 
# Borneo case study
# ------------------------------------------------------------------------------------------------------------#
...
library(reshape2); library(rgeos); library(grid); library(rasterVis);library(ggplotify)
...
# ------------------------------------------------------------------------------------------------------------#
DNM_tch = raster("Harvard/CAO_data/20190521_ElsaPaulSitesPeruSabah/Danum_tch.tif")
DNM_ph  = raster("Harvard/CAO_data/20190521_ElsaPaulSitesPeruSabah/GAO_danum_p_to_h_90m.tif")
DNM_lad = brick("Harvard/CAO_data/20190521_ElsaPaulSitesPeruSabah/GAO_Danum_detto_spherelad_90m_maskd.tif")
# ------------------------------------------------------------------------------------------------------------#
...
# ------------------------------------------------------------------------------------------------------------#
DNM_nplma = brick("Harvard/CAO_data/20190521_ElsaPaulSitesPeruSabah/Masked_danum_chems.tif")
DNM_lma    <- DNM_nplma[[1]]
